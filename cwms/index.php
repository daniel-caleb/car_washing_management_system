        ...
        <div class="about">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-img">
                            <img src="img/about.jpg" alt="Image" width="600" height="650">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="about-content">
                            <p>
                                We have become one of the Kenya’s largest hand car wash and valeting companies, because we shine in smart, eco-friendly car cleaning technology.
                            </p>
                            <ul>
